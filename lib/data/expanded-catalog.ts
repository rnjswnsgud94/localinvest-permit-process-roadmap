...
const supplementalPermitCondition = (
  ...
  : procedureId === "industrial-water-master-plan-reflection-consultation"
    ? {
        all: [
          { gt: { path: "utilities.waterDemandM3Day", value: 0 } },
          {
            eq: {
              path: "confirmation.supplementalPermitTargets.industrial-water-master-plan-reflection-consultation",
              value: true,
            },
          },
        ],
...
const supplementalPermitRequiredInputs = (
  ...
  : procedureId === "industrial-water-master-plan-reflection-consultation"
    ? [
        ...
        "confirmation.supplementalPermitTargets.industrial-water-master-plan-reflection-consultation",
      ]
  : procedureId === "water-supply-factory-restriction-zone-review" ||
      procedureId === "han-river-riparian-zone-factory-location-review"
    ? [
...
const sourceSeeds: SourceSeed[] = [
  ...
  { id: "src-national-land-planning-decree-current", title: "국토의 계획 및 이용에 관한 법률 시행령", authority: "국토교통부", url: "https://www.law.go.kr/법령/국토의계획및이용에관한법률시행령", documentType: "ENFORCEMENT_DECREE" },
  ...
  { id: "src-forest-resources-act-current", title: "산림자원의 조성 및 관리에 관한 법률", authority: "산림청", url: "https://www.law.go.kr/법령/산림자원의조성및관리에관한법률" },
  ...
  { id: "src-private-road-act-current", title: "사도법", authority: "국토교통부", url: "https://www.law.go.kr/법령/사도법/제4조" },
  ...
  { id: "src-water-supply-decree-current", title: "수도법 시행령", authority: "기후에너지환경부", url: "https://www.law.go.kr/법령/수도법시행령", effectiveDate: "2026-06-09", mst: "286843", documentType: "ENFORCEMENT_DECREE" },
  { id: "src-national-water-master-plan-2025-second-amendment", title: "국가수도기본계획 부분변경", authority: "기후에너지환경부", url: "https://www.law.go.kr/LSW/admRulLsInfoP.do?admRulSeq=2100000269374", effectiveDate: "2025-12-05", documentType: "NOTICE" },
  ...
  { id: "src-construction-safety-management-guideline-current", title: "건설공사 안전관리 업무수행 지침", authority: "국토교통부", url: "https://www.law.go.kr/LSW/admRulSideInfoP.do?admRulSeq=2100000216960&chrClsCd=010201&dashNo=&docCls=jo&joBrNo=00&joNo=0021&urlMode=admRulScJoRltInfoR", effectiveDate: "2023-01-01", documentType: "ADMINISTRATIVE_RULE" },
  { id: "src-facilities-safety-act-current", title: "시설물의 안전 및 유지관리에 관한 특별법", authority: "국토교통부", url: "https://www.law.go.kr/LSW/lsInfoP.do?lsId=000237" },
  { id: "src-fms-operation-regulation-20240417", title: "시설물통합정보관리체계 운영규정", authority: "국토교통부", url: "https://www.law.go.kr/LSW/admRulInfoP.do?admRulSeq=2100000239416&chrClsCd=010201", effectiveDate: "2024-04-17", documentType: "ADMINISTRATIVE_RULE" },
  { id: "src-osh-enforcement-rule-20260601", title: "산업안전보건법 시행규칙", authority: "고용노동부", url: "https://www.law.go.kr/LSW/lsLinkCommonInfo.do?lspttninfSeq=154031", effectiveDate: "2026-06-01", documentType: "ENFORCEMENT_RULE" },
  { id: "src-gov24-temporary-building-permit-current", title: "정부24 가설건축물 축조허가 민원안내", authority: "정부24·국토교통부", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=15000000075", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-temporary-building-report-current", title: "정부24 가설건축물 축조신고 민원안내", authority: "정부24·국토교통부", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=15000000077&HighCtgCD=A09006", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-private-road-opening-permit-current", title: "정부24 사도개설 허가 민원안내", authority: "정부24·국토교통부", url: "https://m.gov.kr/mw/AA020InfoCappView.do?CappBizCD=15000000226&HighCtgCD=A03005", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-forestland-temporary-use-permit-current", title: "정부24 산지일시사용허가 민원안내", authority: "정부24·산림청", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=14000000118&HighCtgCD=A09006", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-forestland-temporary-use-report-current", title: "정부24 산지일시사용신고 민원안내", authority: "정부24·산림청", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=14000000119&HighCtgCD=A09006", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-standing-timber-felling-permit-current", title: "정부24 입목벌채·굴취 허가 민원안내", authority: "정부24·산림청", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=14000000038&HighCtgCD=A09008&tp_seq=01", documentType: "OFFICIAL_SERVICE_GUIDE" },
  { id: "src-gov24-standing-timber-felling-report-current", title: "정부24 입목벌채·굴취 신고 민원안내", authority: "정부24·산림청", url: "https://www.gov.kr/mw/AA020InfoCappView.do?CappBizCD=14000000060&HighCtgCD=A09008&tp_seq=01", documentType: "OFFICIAL_SERVICE_GUIDE" },
...
type PermitSeed = {
  ...
  durationPlanningBasis?: DurationEstimate["planningBasis"];
  variability?: string[];
  deemedBy?: string[];
  deems?: string[];
};
...
const permitSeeds: PermitSeed[] = [
  ...
  {
    id: "industrial-water-master-plan-reflection-consultation",
    name: "공업용수 공급계획 반영 협의(국가·관할 수도정비계획)",
    aliases: ["국가수도기본계획 반영", "공업용수 공급계획 반영", "수도정비계획 변경 협의", "수도정비기본계획", "수도정비기본계획 반영"],
    description: "신규·증설 사업의 공업용수 수요를 기존 국가수도기본계획·관할 수도정비계획과 시설 여유량으로 수용할 수 없거나 광역·공업용수도 시설의 신설·증설·분기 등이 필요한 경우, 관계기관에 계획 반영 여부를 확인하는 상위계획 협의입니다. 기업이 직접 받는 허가가 아니며, 계획 반영만으로 공급이 보장되거나 후속 사업·설치 인가가 완료되지 않습니다.",
    outcome: "기존 계획·공급능력 충족 공식 회신 또는 계획 변경 필요성 확인과 승인·고시 완료 추적",
    stage: "SITE_REVIEW",
    actionType: "CONSULTATION",
    domain: "용수·공급계획",
    lane: "CENTRAL_OR_REGIONAL_OFFICE",
    applicant: "직접 법정 신청인 없음(사업주는 수요자료를 제공하고 관할 지자체·산업단지 사업시행자·수도사업자 경로로 반영 여부 협의)",
    authority: "기후에너지환경부 및 관할 수도정비계획 수립권자",
    decisionMaker: "기후에너지환경부장관(국가계획 수립·변경·고시 및 수도정비계획 승인)",
    consultations: ["관할 지방자치단체 수도·산업입지 부서", "산업단지 지정권자·사업시행자", "한국수자원공사 또는 해당 수도사업자", "필요 시 산업통상부·관계 중앙행정기관"],
    submissions: ["단계별 일평균·일최대 공업용수 수요와 공급개시 시점", "원수·정수 구분 및 재이용·대체수원 계획", "사업지·산업단지·공장부지와 기존 수도공급구역 자료", "취수·정수·가압·관로 신설·증설·분기 개략계획", "공급기관의 기존 시설 여유량·공급가능성 검토 회신", "사업비·재원분담·단계별 시행계획"],
    followUp: ["기존 국가계획·수도정비계획과 공급능력으로 수용 가능한지 공식 회신 확보", "국가계획 변경이 필요하면 담당 부처의 변경 검토와 필요한 실무협의·행정예고(해당 시), 부분변경 승인·고시 완료 문서 확보", "지방 수도시설의 공급구역·공급능력 등이 바뀌면 수도정비계획 변경 및 장관 승인 완료 여부 확인", "계획 반영 뒤에도 공급협약, 공급방식에 따른 공업용수도사업 인가(제49조) 또는 전용공업용수도 설치인가(제52조·제54조)와 관로 공사 인허가를 별도 이행"],
    sourceId: "src-water-supply-act-current",
    article: "제4조·제5조·제48조·제49조·제52조·제54조",
    citationSummary: "국가수도기본계획에는 공업용수도의 수요 전망·관리와 일반수도·공업용수도 설치·관리계획이 포함되고, 지방 수도정비계획은 국가계획을 바탕으로 수립·중요 변경 시 장관 승인을 받는다. 국가는 산업단지에 공업용수도시설을 공급하고, 제48조제2항에 따른 공장이 국가계획상 수도공급구역 안에 설립되며 부지면적이 30만㎡ 이상인 경우 시설을 설치·공급하거나 다른 수도사업자에게 하게 할 수 있다. 실제 공급은 공급방식에 따른 사업·설치 인가와 구분된다.",
    condition: supplementalPermitCondition("industrial-water-master-plan-reflection-consultation"),
    requiredInputs: supplementalPermitRequiredInputs("industrial-water-master-plan-reflection-consultation"),
    explanation: "추가 용수수요가 있고 기존 계획·시설능력만으로 공급할 수 없어 국가수도기본계획 또는 관할 수도정비계획 반영·변경이 필요하다고 공급기관·관할기관이 확인했습니다.",
    reviewNote: "업종명, 산업단지 입주 또는 용수수요량만으로 계획 변경 필요성을 자동 확정하지 않습니다. 수도법 제48조제2항의 30만㎡는 공장 부지면적과 국가계획상 수도공급구역을 함께 보는 기준이므로 개발면적·건축연면적으로 대체하지 않습니다. AI 데이터센터에도 공장 기준을 자동 적용하지 않습니다. 수도법령에는 기업의 직접 반영 신청절차나 정형화된 신청서가 별도로 규정되어 있지 않으며, 표시한 준비자료는 공급기관과의 실무 협의자료입니다. 국가수도기본계획 중 제4조제2항제20호의 설치·관리계획 사항만 변경하는 경우에는 제4조제4항의 관계 중앙행정기관·시·도지사 사전협의 의무에서 제외되므로, 실제 변경 항목별 실무협의·행정예고 범위는 담당 부처에 확인해야 합니다. 계획 반영은 공급권 보장이나 공급계약·후속 사업·설치 인가를 대체하지 않습니다.",
    verified: true,
    statutoryPeriod: "국가수도기본계획 반영 협의·부분변경의 프로젝트별 전국 공통 총 처리기간은 수도법령에 규정되지 않음",
    durationEvidence: "INSUFFICIENT_DATA",
    durationSourceId: "src-water-supply-act-current",
    durationArticle: "제4조·제5조",
    durationCitationSummary: "수도법은 국가수도기본계획과 수도정비계획의 수립·변경·승인·고시 구조를 정하지만 개별 사업의 반영 협의부터 계획 변경 고시까지의 총 처리기간은 정하지 않는다.",
    variability: ["기존 공급구역·시설 여유량", "신규 수원·관로·가압시설 범위", "국가계획·수도정비계획 변경 범위", "관계기관 협의·재원분담·행정예고"],
  },
  {
  ...
  },
  {
    ...
    name: "수질오염총량 개발·시설별 오염부하량 할당 확인",
    aliases: ["수질오염총량 개발부하량 협의", "사업장 오염부하량 할당", "한강수계 오염부하량 할당", "금강수계 오염총량 할당", "낙동강수계 오염총량 할당", "영산강·섬진강수계 오염총량 할당"],
    description: "수질오염총량관리지역의 개발사업·오염물질 배출시설은 관할 시·군 시행계획과 시설별 오염부하량 할당 가능 여부를 확인해야 합니다. 한강뿐 아니라 금강·낙동강·영산강·섬진강 등 적용 수계의 특별법·시행계획에 따라 후속 건축·통합환경·폐수시설 인허가가 제한될 수 있으므로 독립 승인으로 과장하지 않고 선행 확인으로 관리합니다.",
    outcome: "개발부하량·시설별 오염부하량 할당 가능 여부와 후속 인허가 영향 확인",
    ...
    consultations: ["관할 유역·지방환경청", "관할 인허가 부서", "공공하수도·수질총량 부서"],
    submissions: ["관할 수계·시군 오염총량 시행계획 적용 확인", "개발 전후 오염부하량 산정", "일일 오수·폐수량과 처리계획", "개발부하량·시설별 할당 확보자료"],
    followUp: ["할당량과 삭감계획을 개발·배출시설 허가조건에 반영", "연도별 시행계획·잔여량 변경 재확인"],
    sourceId: "src-water-act-current-20260219", article: "제4조의5", citationSummary: "환경부장관은 오염총량관리 기본방침에 따라 오염물질을 배출하는 시설에 오염부하량 또는 배출량을 할당할 수 있으며 시행계획 수립 지방자치단체와 미리 협의해야 한다.",
    ...
    reviewNote: "수계명이나 시·군명만으로 자동 적용하지 않습니다. 관할 수계 특별법과 시·군의 현행 시행계획, 시설별 할당대상, 일일 오수·폐수량, 잔여 개발부하량을 확인하며 이를 별도 인허가나 자동 승인으로 표현하지 않습니다. 기존 내부 ID는 공유 URL 호환을 위해 유지합니다.", verified: true,
    statutoryPeriod: "개발부하량·시설별 할당 확인에 관한 전국 공통 처리기간 없음", durationEvidence: "INSUFFICIENT_DATA", durationSourceId: "src-water-act-current-20260219", durationArticle: "제4조의5", durationCitationSummary: "시설별 오염부하량 할당 근거는 두지만 개별 사업의 할당 가능 여부 확인을 끝내는 전국 공통 완료기한은 별도로 정하지 않는다.", variability: ["관할 수계·시군 시행계획", "잔여 개발부하량", "오수·폐수량", "삭감계획"],
  },
  {
  ...
  {
    id: "mechanical-equipment-start-confirmation", name: "기계설비공사 착공 전 확인", aliases: ["기계설비 착공신고", "기계설비공사 착공신고"], description: "법정 대상 건축물의 냉난방·환기·급배수 등 기계설비공사를 시작하기 전에 설계도서가 기술기준에 맞는지 확인받는 절차입니다.", outcome: "기계설비 착공 전 확인 결과 통보서",
  ...
  {
    id: "integrated-environmental-permit", name: "환경오염시설 통합허가", aliases: ["환경통합법 인허가", "통합환경 인허가"], description: "시행령상 대상 업종의 대기·수질 1·2종 등 대형 사업장이 개별 배출시설 허가를 통합환경관리계획으로 묶어 설치·운영 허가받는 절차입니다.", outcome: "배출시설등 설치·운영 통합허가서",
  ...
  {
    id: "hazardous-materials-facility-installation-permit", name: "위험물 제조소등 설치·변경허가", aliases: ["위험물취급소 허가", "위험물취급소", "위험물 저장소 설치허가"], description: "물질별 지정수량 이상의 위험물을 제조·저장·취급하는 제조소·저장소·취급소를 설치하거나 중요설비를 변경하기 전에 받는 허가입니다.", outcome: "위험물 제조소등 설치·변경허가서",
  ...
  {
    id: "disaster-impact-assessment-consultation", name: "재해영향평가등 협의", aliases: ["재해영향평가", "재해영향성검토"], description: "자연재해에 영향을 미치는 개발계획·사업의 승인 전에 재해영향성검토 또는 재해영향평가 자료를 작성해 관계기관 협의를 거치는 절차입니다.", outcome: "재해영향평가등 협의의견",
  ...
  {
    id: "military-protection-consultation", name: "군사기지·군사시설 보호구역 협의", aliases: ["비행안전구역 고도제한 협의", "군 비행장 고도협의", "군사시설 보호구역 협의"], description: "보호구역 안에서 건축·개발행위 등을 허가하려는 경우 허가권자가 군사작전·시설보호 영향을 관할부대와 협의하는 절차입니다.", outcome: "국방부장관 또는 관할부대 협의회신",
  ...
  {
    id: "construction-safety-management-plan-approval", name: "건설공사 안전관리계획 수립·승인", aliases: ["안전관리계획서 승인", "CSI 안전관리계획서 검토", "안전관리계획서 검토"], description: "법정 규모·공법의 건설공사 착공 전에 안전관리계획을 수립해 발주자 또는 인허가기관의 승인을 받고 적정성 검토를 거치는 절차입니다.", outcome: "안전관리계획 승인·적정성 검토결과",
  ...
  {
    id: "industrial-complex-plan-change-approval",
    name: "산업단지계획 변경승인",
    aliases: ["산업단지 개발계획 변경", "산업단지 실시계획 변경", "산단계획 변경승인"],
    description: "산업단지의 토지이용·기반시설·사업시행자·개발기간 등 승인된 개발계획·실시계획 또는 통합 산업단지계획을 바꾸는 경우 지정권자의 변경승인을 받는 절차입니다. 단순 입주계약 변경과 구분하며 경미한 변경 예외는 원 승인계획과 법정 기준을 대조합니다.",
    outcome: "산업단지계획 변경승인·고시 또는 경미한 변경 확인",
    stage: "PLAN_AND_OCCUPANCY", actionType: "APPROVAL", domain: "산업단지·계획변경", lane: "PROVINCE",
    applicant: "산업단지 개발사업 시행자", authority: "산업단지 지정권자", decisionMaker: "산업단지 지정권자",
    consultations: ["산업단지계획심의위원회", "관리기관·관할 지자체", "환경·교통·농지·산지 등 관계기관"],
    submissions: ["기존 승인·고시된 산업단지계획", "변경 전후 토지이용·기반시설·사업기간 비교표", "변경 사유와 사업비·재원계획", "개별 인허가 의제서류(해당 시)", "경미한 변경 검토자료"],
    followUp: ["변경승인·고시 조건을 실시설계와 개별 인허가에 반영", "의제할 인허가는 서류 포함·관계기관 협의 결과를 별도 확인", "관리기본계획·입주계약 변경 필요 여부 별도 검토"],
    sourceId: "src-industrial-complex-fast-track-act-20251001", article: "제15조·제15조의2", citationSummary: "산업단지계획 승인·고시와 변경승인 절차를 두고, 대통령령상 경미한 변경에 한하여 의견청취·위원회 심의의 일부를 생략할 수 있다.",
    condition: supplementalPermitCondition("industrial-complex-plan-change-approval"), requiredInputs: supplementalPermitRequiredInputs("industrial-complex-plan-change-approval"),
    explanation: "승인된 산업단지 개발·실시계획 또는 통합 산업단지계획을 변경해야 하는 것으로 확인되어 변경승인 경로를 포함합니다.",
    reviewNote: "입주기업의 건축·공정 변경이 곧바로 산업단지계획 변경을 뜻하지 않습니다. 원 승인·고시문, 변경항목, 경미한 변경 기준과 의제서류·관계기관 협의 여부를 지정권자에게 확인합니다. 신규 산업단지계획 승인에 적용되는 6개월 상한을 모든 변경승인의 총기간으로 일반화하지 않습니다.", verified: true,
    statutoryPeriod: "변경 내용·심의·협의 분기에 공통 적용되는 전국 단일 총 처리기간 미규정", durationEvidence: "INSUFFICIENT_DATA", durationSourceId: "src-industrial-complex-fast-track-act-20251001", durationArticle: "제15조·제15조의2", durationCitationSummary: "산업단지계획 변경승인 절차와 경미한 변경 분기는 규정하지만 모든 변경에 적용되는 전국 공통 총 처리기간은 규정하지 않는다.", durationPlanningBasis: "INSUFFICIENT_DATA", variability: ["변경항목", "경미한 변경 여부", "주민의견·위원회 심의", "관계기관 협의"],
  },
  {
    id: "industrial-complex-management-plan-change",
    name: "산업단지 관리기본계획 변경",
    aliases: ["산단 관리기본계획 변경", "산업단지 업종배치계획 변경", "유치업종 변경"],
    description: "산업단지의 유치업종·업종배치, 입주자격, 용도구역과 기반시설 관리 등 관리기본계획 내용이 투자계획과 맞지 않는 경우 관리기관이 계획 변경과 승인·고시 필요성을 검토하는 절차입니다. 개별 기업의 입주계약만으로 관리기본계획이 자동 변경되지는 않습니다.",
    outcome: "변경된 산업단지 관리기본계획 승인·고시 또는 현행 계획 적합 확인",
    stage: "PLAN_AND_OCCUPANCY", actionType: "CONSULTATION", domain: "산업단지·관리계획", lane: "INDUSTRIAL_COMPLEX_AUTHORITY",
    applicant: "산업단지 관리기관(입주기업은 변경 필요자료를 제출·협의)", authority: "산업단지 관리권자·관리기관 및 법정 승인권자",
    consultations: ["산업단지 관리기관", "관할 시·도·시군 산업단지 부서", "산업통상부 또는 관계 승인기관"],
    submissions: ["현행 관리기본계획·업종배치도", "KSIC·생산품·핵심공정과 부지 위치", "변경 필요성·주변 업종 영향", "토지이용·기반시설 수용성 자료", "기존 입주계약·변경계약 자료"],
    followUp: ["변경 승인·고시 후 입주계약 또는 변경계약 체결", "입주계약과 공장설립·건축·환경 인허가 조건 정합 확인"],
    sourceId: "src-industrial-cluster-act-20260701", article: "제33조", citationSummary: "산업단지 관리권자는 유치업종·업종별 배치계획, 입주자격과 용도별 구역 등을 포함한 관리기본계획을 수립하고 법정 절차에 따라 승인·고시하며 중요 내용을 변경할 때에도 그 절차를 거친다.",
    condition: supplementalPermitCondition("industrial-complex-management-plan-change"), requiredInputs: supplementalPermitRequiredInputs("industrial-complex-management-plan-change"),
    explanation: "계획 업종·배치·용도가 현행 산업단지 관리기본계획과 맞지 않아 계획 변경 협의가 필요한 것으로 확인되었습니다.",
    reviewNote: "개별 산업단지의 현행 관리기본계획 원문과 업종배치도를 수집하지 않은 상태에서는 자동 확정하지 않습니다. 입주계약 변경과 관리기본계획 변경, 산업단지 개발계획 변경을 각각 구분하고 관리기관의 서면 확인을 받아야 합니다.", verified: true,
    statutoryPeriod: "관리기본계획 변경의 관계기관 협의·승인·고시를 모두 포함하는 전국 공통 총 처리기간 미규정", durationEvidence: "INSUFFICIENT_DATA", durationSourceId: "src-industrial-cluster-act-20260701", durationArticle: "제33조", durationCitationSummary: "관리기본계획의 수립·변경·승인·고시 근거는 두지만 전체 변경절차의 전국 공통 총 처리기간은 규정하지 않는다.", variability: ["개별 산업단지 계획", "유치업종·배치 변경 범위", "승인기관 협의", "고시 일정"],
  },
  {
    id: "urban-county-management-plan-change-proposal",
    name: "도시·군관리계획 변경 입안제안",
    aliases: ["도시관리계획 변경", "지구단위계획 변경 입안제안", "용도지역 변경 제안"],
    description: "용도지역·용도지구, 지구단위계획 또는 도시·군계획시설을 바꿔야 사업이 가능한 경우 이해관계자가 관할 입안권자에게 도시·군관리계획 변경 입안을 제안하는 절차입니다. 제안 반영 여부 통지는 최종 계획결정·고시와 구분합니다.",
    outcome: "도시·군관리계획 입안 반영 여부 통보 및 후속 계획결정 절차",
    stage: "SITE_REVIEW", actionType: "REVIEW", domain: "도시계획·입지", lane: "CITY_COUNTY_DISTRICT",
    applicant: "도시·군관리계획 입안을 제안하는 주민·이해관계자", authority: "관할 도시·군관리계획 입안권자",
    consultations: ["도시계획위원회", "관할 시·도·시군 도시계획 부서", "토지소유자·관계 행정기관"],
    submissions: ["도시·군관리계획도서와 계획설명서", "변경 필요성·공공성·실현가능성 자료", "토지이용·교통·환경·기반시설 검토", "법정 토지소유자 동의자료(해당 시)"],
    followUp: ["입안 반영 후 주민의견·관계기관 협의·위원회 심의와 결정·고시 추적", "최종 결정 전 토지이용 가능성을 확정하지 않음"],
    sourceId: "src-national-land-planning-act-20260603", article: "제26조", citationSummary: "주민과 이해관계자는 법정 범위의 도시·군관리계획 입안을 제안할 수 있고 입안권자는 제안의 반영 여부를 통보해야 한다.",
    condition: supplementalPermitCondition("urban-county-management-plan-change-proposal"), requiredInputs: supplementalPermitRequiredInputs("urban-county-management-plan-change-proposal"),
    explanation: "현행 용도지역·지구단위계획 또는 도시·군계획시설 내용의 변경이 필요한 것으로 확인되어 입안제안 경로를 포함합니다.",
    reviewNote: "입안제안 접수만으로 계획이 변경되거나 개발이 허용되지 않습니다. 정확한 필지·현행 계획, 제안 대상과 동의요건을 확인하고 반영 통보 이후의 입안·의견청취·심의·결정·고시를 별도로 관리합니다.", verified: true,
    statutoryPeriod: "시행령상 입안제안 반영 여부는 제안일부터 45일 이내 통보하고 부득이한 경우 한 차례 30일 연장할 수 있으나, 이는 최종 도시·군관리계획 결정기간이 아니며 결정·고시까지의 전국 공통 총기간은 미규정", durationEvidence: "STATUTE", durationSourceId: "src-national-land-planning-decree-current", durationArticle: "제20조", durationCitationSummary: "입안권자는 제안일부터 45일 이내 반영 여부를 통보하고 부득이한 경우 한 차례 30일 연장할 수 있으나, 이 기한은 계획결정·고시까지의 총기간이 아니다.", durationPlanningBasis: "MILESTONE_ONLY", variability: ["제안 대상", "토지소유자 동의", "관계기관 협의", "도시계획위원회·결정고시"],
  },
  {
    id: "urban-planning-facility-implementation-plan-approval",
    name: "도시·군계획시설사업 실시계획 인가",
    aliases: ["도시계획시설 실시계획 인가", "도시계획시설사업 시행자 지정·실시계획인가"],
    description: "도로·공원·상하수도 등 도시·군계획시설을 직접 설치하거나 해당 시설사업으로 부지·기반시설을 조성하는 경우 사업시행자가 실시계획을 작성해 인가받는 절차입니다. 일반 공장 건축이나 단순 기반시설 공급협의와 구분합니다.",
    outcome: "도시·군계획시설사업 실시계획 인가·고시",
    stage: "PLAN_AND_OCCUPANCY", actionType: "APPROVAL", domain: "도시계획·기반시설", lane: "CITY_COUNTY_DISTRICT",
    applicant: "도시·군계획시설사업 시행자", authority: "국토교통부장관, 시·도지사 또는 대도시 시장 등 법정 인가권자",
    consultations: ["도시계획·도로·상하수도 담당부서", "토지·보상 관계기관", "개별 인허가 관계기관"],
    submissions: ["실시계획서·설계도서", "사업기간·사업비·재원계획", "토지·물건 조서와 권원·보상계획", "관계기관 협의 및 의제 인허가 서류"],
    followUp: ["인가·고시 후 실시계획과 조건에 따라 공사", "사업변경 시 변경인가 확인", "공사완료 공고·준공절차 관리"],
    sourceId: "src-national-land-planning-act-20260603", article: "제88조", citationSummary: "도시·군계획시설사업 시행자는 실시계획을 작성해 법정 인가권자의 인가를 받아야 하며, 인가받은 실시계획을 변경하는 경우에도 원칙적으로 변경인가를 받아야 한다.",
    condition: supplementalPermitCondition("urban-planning-facility-implementation-plan-approval"), requiredInputs: supplementalPermitRequiredInputs("urban-planning-facility-implementation-plan-approval"),
    explanation: "사업부지 또는 연결 기반시설 공사가 도시·군계획시설사업으로 시행되는 것으로 확인되어 실시계획 인가 경로를 포함합니다.",
    reviewNote: "시설결정만으로 실시계획 인가가 완료되는 것은 아닙니다. 사업시행자 지정 여부, 시설결정 내용, 사업경계와 의제 인허가 서류·협의결과를 관할 도시계획부서에서 확인합니다.", verified: true,
    statutoryPeriod: "실시계획 작성·인가·고시 전체에 적용되는 전국 공통 총 처리기간 미규정", durationEvidence: "INSUFFICIENT_DATA", durationSourceId: "src-national-land-planning-act-20260603", durationArticle: "제88조", durationCitationSummary: "도시·군계획시설사업 실시계획 인가·변경인가 의무는 두지만 작성·인가·고시 전체의 전국 공통 총 처리기간은 규정하지 않는다.", variability: ["시설 종류·사업경계", "시행자 지정", "토지·보상", "의제 인허가 협의"],
  },
  {
    id: "temporary-building-permit-report",
    name: "가설건축물 축조허가·신고",
    aliases: ["가설건축물 신고", "현장사무소 축조신고", "임시창고 가설건축물"],
    description: "공사현장 사무소·창고 등 존치기간이 정해진 임시 건축물을 축조할 때 위치·구조·용도와 법정 유형에 따라 허가를 받거나 신고하는 절차입니다. 본 건축물의 건축허가와 별도이며 존치기간 연장·철거를 관리해야 합니다.",
    outcome: "가설건축물 축조허가서 또는 신고필증",
    stage: "PRE_CONSTRUCTION", actionType: "PERMIT", domain: "건축·가설시설", lane: "CITY_COUNTY_DISTRICT",
    applicant: "가설건축물을 축조하려는 자", authority: "관할 특별자치시장·특별자치도지사·시장·군수·구청장",
    consultations: ["건축·도시계획 부서", "소방·도로·산지 등 입지 관계부서"],
    submissions: ["배치도·평면도", "구조·용도·면적·높이", "존치기간", "토지사용 권원", "안전·철거·원상복구 계획"],
    followUp: ["허가·신고 후 축조", "존치기간 만료 전 연장신고 또는 철거", "용도·구조 변경 시 변경절차 확인"],
    sourceId: "src-building-act-20260227", article: "제20조", citationSummary: "도시·군계획시설 예정지 등의 가설건축물은 허가를 받아야 하고 재해복구·흥행·전람회·공사용 가설건축물 등 대통령령상 용도의 가설건축물은 신고한 뒤 착공해야 한다.",
    condition: supplementalPermitCondition("temporary-building-permit-report"), requiredInputs: supplementalPermitRequiredInputs("temporary-building-permit-report"),
    explanation: "공사기간에 존치하는 현장사무소·창고 등 가설건축물을 설치하는 것으로 확인되어 축조허가·신고를 포함합니다.",
    reviewNote: "임시 시설이라는 이유만으로 신고 경로를 자동 선택하지 않습니다. 필지, 용도·구조·면적과 조례 추가대상, 존치기간을 대조해 허가·신고를 구분합니다.", verified: true,
    days: [3, 7, 7], statutoryPeriod: "정부24 공식 처리분기: 가설건축물 축조신고 3일, 축조허가 7일", durationEvidence: "OFFICIAL_SERVICE_STANDARD", durationSourceId: "src-gov24-temporary-building-permit-current", durationArticle: "민원 처리기간", durationCitationSummary: "정부24는 가설건축물 축조허가의 공식 처리기간을 총 7일로 안내한다.", durationAssumptions: ["3일과 7일은 신고·허가의 상호배타적 공식 처리분기이며 통상 변동범위가 아님", "존치기간 연장·철거와 보완기간은 별도"], variability: ["허가·신고 유형", "가설 용도·구조", "존치기간", "조례 추가대상"],
  },
  {
    id: "private-road-opening-permit",
    name: "사도 개설허가",
    aliases: ["사도허가", "공장 진입 사도 개설"],
    description: "도로법상 공공도로가 아닌 사도를 새로 개설하거나 주요 내용을 변경하여 공장 진입로로 사용할 때 관할 행정청의 허가를 받는 절차입니다. 공공도로 연결허가·도로점용허가와는 별개입니다.",
    outcome: "사도 개설허가서와 공사·관리 조건",
    stage: "SITE_REVIEW", actionType: "PERMIT", domain: "도로·진입", lane: "CITY_COUNTY_DISTRICT",
    applicant: "사도를 개설하려는 자", authority: "관할 시장·군수·구청장",
    consultations: ["도로관리청", "도시계획·개발행위 부서", "토지소유자·이해관계인"],
    submissions: ["사도개설 허가신청서", "위치도·평면도·종단면도", "토지 권원과 이해관계 자료", "배수·안전·유지관리계획"],
    followUp: ["허가조건에 따라 사도공사·관리", "공공도로 연결허가·개발행위허가 중첩 확인", "변경·폐지 시 후속 허가"],
    sourceId: "src-private-road-act-current", article: "제4조", citationSummary: "사도를 개설하려는 자는 법정 절차에 따라 관할 시장·군수·구청장의 허가를 받아야 하고 허가받은 내용을 변경할 때에도 원칙적으로 변경허가를 받아야 한다.",
    condition: supplementalPermitCondition("private-road-opening-permit"), requiredInputs: supplementalPermitRequiredInputs("private-road-opening-permit"),
    explanation: "공장 진입로가 도로법상 도로가 아닌 사도로 개설되는 것으로 확인되어 사도 개설허가를 포함합니다.",
    reviewNote: "사도 개설허가가 공공도로 연결허가·도로점용허가 또는 개발행위허가를 자동 대체하지 않습니다. 도로의 법적 성격, 토지권원과 실제 연결부를 관할 도로부서에 확인합니다.", verified: true,
    days: [7, 7, 7], statutoryPeriod: "정부24 사도개설 허가 공식 처리기간 총 7일", durationEvidence: "OFFICIAL_SERVICE_STANDARD", durationSourceId: "src-gov24-private-road-opening-permit-current", durationArticle: "민원 처리기간", durationCitationSummary: "정부24는 사도개설 허가의 공식 처리기간을 총 7일로 안내한다.", variability: ["토지 권원", "도로 구조·배수", "이해관계·연결부 협의"],
  },
  {
    id: "forestland-temporary-use-permit-report",
    name: "산지일시사용 허가·신고",
    aliases: ["산지 일시사용", "임시 진입로 산지일시사용", "산지일시사용 변경허가·신고"],
    description: "공사용 진입로·야적장 등 산지를 다른 지목으로 영구 전용하지 않고 복구를 전제로 일정 기간 사용하는 경우 목적·면적 등에 따라 허가를 받거나 신고하는 절차입니다. 산지전용허가와 중복되지 않도록 실제 사용형태를 구분합니다.",
    outcome: "산지일시사용 허가서 또는 신고 수리",
    stage: "SITE_REVIEW", actionType: "PERMIT", domain: "입지·산지", lane: "CITY_COUNTY_DISTRICT",
    applicant: "산지를 일시사용하려는 자", authority: "산림청장 또는 관할 시·도지사·시장·군수·구청장 등",
    consultations: ["산지관리 부서", "산림재해·복구 담당부서", "개발행위·환경 부서"],
    submissions: ["산지일시사용 허가·신고서", "위치·면적·기간·목적", "사업계획·시설배치도", "재해방지·복구계획", "토지 권원"],
    followUp: ["허가·신고 조건과 사용기간 준수", "기간·면적·목적 변경 시 변경절차", "사용 종료 후 산지복구·준공검사 확인"],
    sourceId: "src-forestland-act-current", article: "제15조의2", citationSummary: "산지를 복구할 것을 조건으로 일시사용하려는 자는 용도·규모 등에 따라 허가를 받거나 신고해야 하며 변경 시에도 법정 절차를 거쳐야 한다.",
    condition: supplementalPermitCondition("forestland-temporary-use-permit-report"), requiredInputs: supplementalPermitRequiredInputs("forestland-temporary-use-permit-report"),
    explanation: "산지를 영구 전용하지 않고 공사용 시설 등으로 일시 사용한 뒤 복구하는 것으로 확인되어 허가·신고를 포함합니다.",
    reviewNote: "지목이나 산지 소재만으로 자동 적용하지 않습니다. 실제 목적·면적·기간과 산지전용 여부를 대조하고, 허가·신고 분기 및 복구의무를 관할 산지관리기관과 확인합니다.", verified: true,
    days: [10, 25, 25], statutoryPeriod: "정부24 공식 처리분기: 산지일시사용신고 10일, 허가 25일; 신고기간 연장신고는 5일", durationEvidence: "OFFICIAL_SERVICE_STANDARD", durationSourceId: "src-gov24-forestland-temporary-use-permit-current", durationArticle: "민원 처리기간", durationCitationSummary: "정부24는 산지일시사용허가의 공식 처리기간을 총 25일로 안내한다.", durationAssumptions: ["10일과 25일은 신고·허가의 상호배타적 공식 처리분기이며 통상 변동범위가 아님", "연장신고 5일은 사용기간 변경 분기의 별도 처리기간이므로 최초 허가·신고에 합산하지 않음"], variability: ["허가·신고 유형", "목적·면적·기간", "재해방지·복구계획"],
  },
  {
    id: "standing-timber-felling-permit-report",
    name: "입목벌채·굴취 허가·신고",
    aliases: ["입목벌채허가", "벌채신고", "수목 굴취허가"],
    description: "산림 안의 입목을 벌채하거나 굴취해 공사부지를 정리하는 경우 산림경영·수종·면적과 법정 예외에 따라 허가를 받거나 신고하는 절차입니다. 산지전용·일시사용 인허가에 벌채가 포함되는지부터 확인합니다.",
    outcome: "입목벌채·굴취 허가서 또는 신고 수리",
    stage: "PRE_CONSTRUCTION", actionType: "PERMIT", domain: "입지·산림", lane: "CITY_COUNTY_DISTRICT",
    applicant: "입목을 벌채·굴취하려는 산림소유자 또는 권원 있는 사업자", authority: "산림청장 또는 관할 시장·군수·구청장 등",
    consultations: ["산림경영·산지관리 부서", "국유림관리소", "재해·복구 담당부서"],
    submissions: ["벌채·굴취 허가·신고서", "위치·면적·수종·수량 산출", "조림·복구계획", "토지·입목 권원", "산지전용·일시사용 인허가 자료"],
    followUp: ["허가·신고 조건에 따른 벌채·굴취", "조림·복구 및 반출기록 관리", "면적·수량 변경 시 변경절차 확인"],
    sourceId: "src-forest-resources-act-current", article: "제36조", citationSummary: "산림의 입목을 벌채하거나 임산물을 굴취·채취하려는 자는 법정 예외를 제외하고 허가를 받거나 신고해야 한다.",
    condition: supplementalPermitCondition("standing-timber-felling-permit-report"), requiredInputs: supplementalPermitRequiredInputs("standing-timber-felling-permit-report"),
    explanation: "공사 전에 산림의 입목을 벌채·굴취해야 하고 별도 허가·신고 대상인 것으로 확인되어 절차를 포함합니다.",
    reviewNote: "산지전용·일시사용 허가에 포함되는 벌채와 별도 산림자원법 절차를 중복 계산하지 않습니다. 산림 여부, 수종·면적·수량, 권원과 예외를 관할 산림부서에서 확인합니다.", verified: true,
    days: [7, 30, 30], statutoryPeriod: "공식 처리분기: 일반 허가·신고 30일, 사전타당성조사를 거친 허가는 조사결과 통지 후 7일", durationEvidence: "OFFICIAL_SERVICE_STANDARD", durationSourceId: "src-gov24-standing-timber-felling-permit-current", durationArticle: "민원 처리기간", durationCitationSummary: "정부24는 입목벌채·굴취 허가의 공식 처리기간을 총 30일로 안내하며 사전타당성조사를 거친 분기는 조사결과 통지 후 7일로 구분한다.", durationAssumptions: ["7일과 30일은 사전타당성조사 실시 여부에 따른 공식 분기이며 통상 변동범위가 아님", "현장조사·조림·복구와 산지 인허가 기간은 별도"], variability: ["허가·신고 유형", "사전타당성조사", "수종·면적·수량", "조림·복구조건"],
  },
  {
    id: "psm-pre-operation-confirmation",
    name: "공정안전보고서(PSM) 가동 전 이행상태 확인",
    aliases: ["PSM 확인", "PSM 가동 전 확인", "공정안전보고서 이행상태 확인"],
    description: "공정안전보고서 심사를 받은 사업주가 유해·위험설비의 설치·변경을 마치고 실제 가동하기 전에 보고서 내용이 현장에 이행됐는지 한국산업안전보건공단의 확인을 받는 절차입니다. 공정안전보고서 제출·심사와 별도 단계입니다.",
    outcome: "공정안전보고서 이행상태 확인결과",
    stage: "PRE_OPERATION", actionType: "INSPECTION", domain: "산업안전·PSM", lane: "ENVIRONMENT_SAFETY_FIRE_UTILITY",
    applicant: "공정안전보고서 심사를 받은 사업주", authority: "고용노동부장관·한국산업안전보건공단",
    consultations: ["관할 지방고용노동관서", "한국산업안전보건공단", "공정·설비·안전 담당부서"],
    submissions: ["심사 완료 공정안전보고서와 결과", "설비 설치·변경 완료자료", "현장 이행점검 자료", "시운전·가동계획", "자체감사 결과(확인 생략 특례 검토 시)"],
    followUp: ["확인결과의 보완·개선조치 이행", "적합 확인 후 안전조건에 따라 가동", "변경사항의 PSM 재심사·변경관리 확인"],
    sourceId: "src-osh-act-20260601", article: "제46조제2항", citationSummary: "공정안전보고서를 제출해 심사를 받은 사업주는 보고서 내용을 실제로 이행하고 있는지 고용노동부장관의 확인을 받아야 한다.",
    condition: supplementalPermitCondition("psm-pre-operation-confirmation"), requiredInputs: supplementalPermitRequiredInputs("psm-pre-operation-confirmation"),
    explanation: "PSM 심사대상 설비의 설치·변경 후 가동 전 이행상태 확인이 필요한 것으로 확인되어 별도 점검 단계를 포함합니다.",
    reviewNote: "업종명이나 PSM 보고서 제출 사실만으로 확인시점을 자동 확정하지 않습니다. 시행규칙 제53조의 설비별 확인시기, 자체감사 제출에 따른 확인 생략 가능성, 실제 시운전·가동계획을 공단과 확인합니다.", verified: true,
    statutoryPeriod: "신규 설비는 설치과정·설치완료 후 시운전단계에 각각 1회, 기존 설비는 심사완료 후 3개월 이내, 중대한 변경은 변경 완료 후 1개월 이내 확인; 공단은 확인요청일부터 1개월 이내 확인하고 확인일부터 15일 이내 결과 통보. 서로 다른 분기·기산점이며 PSM 심사나 접수부터 가동까지의 전국 공통 총기간은 미규정", durationEvidence: "STATUTE", durationSourceId: "src-osh-enforcement-rule-20260601", durationArticle: "제53조", durationCitationSummary: "공정안전보고서 확인시기를 신규·기존·중대한 변경 설비별로 구분하고, 공단은 요청일부터 1개월 이내 확인한 뒤 확인일부터 15일 이내 결과를 통보한다.", durationPlanningBasis: "MILESTONE_ONLY", variability: ["설비별 확인시점", "현장 확인 예약", "보완·개선조치", "자체감사 확인 생략 여부"],
  },
  {
    id: "building-temporary-use-approval",
    name: "건축물 임시사용승인",
    aliases: ["부분 임시사용승인", "준공 전 임시사용", "건축물 임시사용"],
    description: "전체 건축물의 사용승인을 받기 전에 공사가 완료된 부분을 먼저 사용해야 하는 경우, 안전·방화·피난 등 법정 기준 충족 여부를 확인받아 한시적으로 사용하는 절차입니다. 전체 사용승인 면제나 자동 승인으로 표현하지 않습니다.",
    outcome: "건축물 임시사용승인서와 사용범위·기간·조건",
    stage: "PRE_OPERATION", actionType: "APPROVAL", domain: "건축·사용", lane: "CITY_COUNTY_DISTRICT",
    applicant: "건축주", authority: "관할 건축허가권자",
    consultations: ["건축감리자", "소방·전기·가스·승강기 등 관계기관", "관할 건축안전 부서"],
    submissions: ["임시사용승인 신청서", "공사가 완료된 부분의 도면·현황", "감리완료·공사완료 자료", "안전·방화·피난·위생 적합자료", "사용범위·기간과 잔여공사 안전계획"],
    followUp: ["승인된 범위·기간·조건 안에서만 사용", "잔여공사와 사용구역의 안전분리", "최종 사용승인 신청·검사 완료"],
    sourceId: "src-building-act-20260227", article: "제22조제3항", citationSummary: "건축주는 사용승인을 받기 전 건축물을 사용할 수 없지만, 공사가 완료된 부분이 대통령령상 기준에 적합하면 허가권자의 임시사용승인을 받아 그 부분을 사용할 수 있다.",
    condition: supplementalPermitCondition("building-temporary-use-approval"), requiredInputs: supplementalPermitRequiredInputs("building-temporary-use-approval"),
    explanation: "전체 사용승인 전에 공사가 끝난 일부 구역을 운영해야 하는 것으로 확인되어 임시사용승인 경로를 포함합니다.",
    reviewNote: "일정 단축 필요만으로 승인 가능성을 전제하지 않습니다. 시행령 제17조의 구조·피난·방화 등 기준, 사용구역·잔여공사 분리와 관계기관 검사 완료 여부를 허가권자와 확인합니다. 승인기간은 원칙적으로 2년 이내이고 최종 사용승인을 대체하지 않습니다.", verified: true,
    days: [7, 7, 7], durationUnit: "CALENDAR_DAY", statutoryPeriod: "건축법 시행규칙상 임시사용승인 신청일부터 7일 이내 임시사용승인서 발급; 승인기간은 원칙적으로 2년 이내", durationEvidence: "STATUTE", durationSourceId: "src-building-act-enforcement-rule-20260227", durationArticle: "제17조제4항", durationCitationSummary: "허가권자는 임시사용승인 신청서를 받은 날부터 7일 이내 임시사용승인서를 발급해야 하며 승인기간은 건축법 시행령상 원칙적으로 2년 이내이다.", durationAssumptions: ["7일은 완비 신청의 법정 발급기한이며 잔여공사·관계기관 검사·보완기간은 별도", "2년은 승인 유효기간이지 처리기간이 아님"], variability: ["부분 사용범위", "안전·피난·방화 기준", "관계기관 검사", "잔여공사 분리"],
  },
  {
    id: "facility-management-document-registration",
    name: "시설물관리대장·설계도서 등 FMS 제출·등록",
    aliases: ["FMS 설계도서 등록", "시설물관리대장 등록", "시설물통합정보관리체계 제출"],
    description: "시설물안전법상 제1종·제2종시설물의 준공·사용승인 단계에서 시설물관리대장과 설계도서 등을 시설물통합정보관리체계(FMS)에 제출하고 감리보고서를 후속 등록하는 절차입니다. 일반 건축물 전체에 자동 적용하지 않습니다.",
    outcome: "시설물관리대장·설계도서·감리보고서 FMS 제출·등록 확인",
    stage: "PRE_OPERATION", actionType: "REGISTRATION", domain: "건설·시설물안전", lane: "CENTRAL_OR_REGIONAL_OFFICE",
    applicant: "시설물안전법상 제출의무자", authority: "국토교통부장관·시설물통합정보관리체계 운영기관 및 관계 행정기관",
    consultations: ["발주자·시공자·감리자", "관할 사용승인 부서", "시설물 관리주체·FMS 운영기관"],
    submissions: ["시설물관리대장", "준공도서·구조계산서 등 법정 설계도서", "공사·감리보고서", "안전점검·품질관리 자료", "시설물 분류·관리주체 정보"],
    followUp: ["준공·사용승인 후 3개월 이내 감리보고서 제출", "증축 등 변경 시 변경도서 재제출", "관리대장·유지관리이력 최신화"],
    sourceId: "src-facilities-safety-act-current", article: "제9조", citationSummary: "제1종·제2종시설물의 설계자·시공자 등 제출의무자는 설계도서와 시설물관리대장 등을 관리주체와 국토교통부장관에게 제출해야 하고 관계 행정기관은 제출 여부를 확인해야 한다.",
    condition: supplementalPermitCondition("facility-management-document-registration"), requiredInputs: supplementalPermitRequiredInputs("facility-management-document-registration"),
    explanation: "시설물안전법상 제1종·제2종시설물의 준공·사용승인 단계 제출대상으로 확인되어 FMS 등록 이정표를 포함합니다.",
    reviewNote: "연면적이나 공장이라는 이유만으로 자동 적용하지 않습니다. 시설물 종류·규모와 제1종·제2종 분류, 제출의무자, 관할 사용승인부서의 확인자료 목록을 대조합니다.", verified: true,
    statutoryPeriod: "시설물관리대장·설계도서 등은 준공 또는 사용승인 전에 제출하고, 감리보고서는 준공 또는 사용승인 후 3개월 이내 제출; 서로 다른 제출 이정표이며 전국 공통 행정처리 총기간 미규정", durationEvidence: "STATUTE", durationSourceId: "src-fms-operation-regulation-20240417", durationArticle: "제34조", durationCitationSummary: "시설물관리대장·설계도서 등의 준공·사용승인 전 제출과 감리보고서의 준공·사용승인 후 3개월 이내 제출을 구분하며 행정처리 총기간은 정하지 않는다.", durationPlanningBasis: "MILESTONE_ONLY", variability: ["시설물 종별", "제출도서 범위", "관계 행정기관 확인", "FMS 보완"],
  },
  {
    id: "construction-restart-safety-inspection",
    name: "장기 중단 건설공사 재착공 전 안전점검",
    aliases: ["공사재개 전 안전점검", "재착공 안전점검", "1년 이상 중단공사 안전점검"],
    description: "안전관리계획 수립대상 건설공사가 중단되어 시설물이 1년 이상 방치된 뒤 공사를 재개하는 경우, 재착공 전에 구조·가설물·현장상태를 점검하는 절차입니다. 모든 공사중단이나 일반 재착공에 자동 적용하지 않습니다.",
    outcome: "공사재개 전 안전점검 결과와 보수·보강 조치 확인",
    stage: "PRE_CONSTRUCTION", actionType: "INSPECTION", domain: "건설·재착공안전", lane: "ENVIRONMENT_SAFETY_FIRE_UTILITY",
    applicant: "안전관리계획 대상 건설공사의 시공자·발주자", authority: "발주자·인허가기관 및 지정 건설안전점검기관",
    consultations: ["건설안전점검기관", "발주자·감리자", "관할 인허가기관·건축안전 부서"],
    submissions: ["공사중단·재개 일정과 현장보존 기록", "기존 안전관리계획·안전점검 결과", "구조물·가설물 현황조사", "재착공 공법·보수보강 계획", "점검기관 지정·계약 자료"],
    followUp: ["점검결과에 따른 보수·보강 후 공사재개", "안전관리계획 변경·승인 필요 여부 확인", "점검결과 제출·보관"],
    sourceId: "src-construction-technology-act-current", article: "제62조", citationSummary: "안전관리계획 대상 건설공사의 시공자는 공사 안전을 확보하기 위한 안전점검을 실시하고 그 결과에 따라 필요한 조치를 해야 한다.",
    condition: supplementalPermitCondition("construction-restart-safety-inspection"), requiredInputs: supplementalPermitRequiredInputs("construction-restart-safety-inspection"),
    explanation: "안전관리계획 대상 공사가 중단되어 시설물이 1년 이상 방치된 뒤 재개되는 것으로 확인되어 재착공 전 안전점검을 포함합니다.",
    reviewNote: "공사중단 사실만으로 자동 적용하지 않습니다. 시행령 제98조제1항 대상 여부, 1년 이상 방치된 시설물의 존재와 점검기관 지정·보수보강 범위를 발주자·인허가기관과 확인합니다.", verified: true,
    statutoryPeriod: "1년 이상 방치된 안전관리계획 대상 공사는 재착공 전에 안전점검을 완료해야 하나 점검기관 지정·현장점검·보수보강을 포함한 전국 공통 총기간 미규정", durationEvidence: "STATUTE", durationSourceId: "src-construction-safety-management-guideline-current", durationArticle: "제21조제4항", durationCitationSummary: "안전관리계획 대상 공사의 중단으로 시설물이 1년 이상 방치된 경우 재개 전 안전점검을 요구하지만 점검·보수보강의 전국 공통 총기간은 정하지 않는다.", durationPlanningBasis: "MILESTONE_ONLY", variability: ["중단기간·현장상태", "구조물·가설물 점검범위", "점검기관 지정", "보수·보강"],
  },
  {
...
expandedCitations.push(
  ...
  {
    id: "cit-exp-industrial-water-master-plan-reflection-consultation-decree",
    sourceId: "src-water-supply-decree-current",
    article: "제6조·제7조",
    paragraph: null,
    subparagraph: null,
    ...
    role: "SEQUENCE",
    sourceVersion: sourceVersion("src-water-supply-decree-current"),
    summary: "수돗물 중장기 수급, 수도공급구역, 수도시설 공급능력과 실시순위 등 수도정비계획의 중요 변경은 장관의 변경승인 대상이며, 승인 전 한국환경공단 또는 한국수자원공사의 시설 규모 기술검토를 의뢰할 수 있다.",
  },
  {
    id: "cit-exp-industrial-water-master-plan-reflection-consultation-current-plan",
    sourceId: "src-national-water-master-plan-2025-second-amendment",
    article: "고시문·시설편",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "SEQUENCE",
    sourceVersion: "기후에너지환경부고시 제2025-46호 · 시행 2025-12-05",
  ...
  },
  {
    ...
    role: "APPLICABILITY",
    sourceVersion: `현행본 검토 ${REVIEW_DATE}`,
    summary: "한강수계 적용 사업의 경우 오염부하량 할당대상 시설과 할당·배출량 지정에 필요한 세부사항을 별도로 규정한다.",
  },
  {
  ...
  {
    id: "cit-exp-temporary-building-report-official-duration",
    sourceId: "src-gov24-temporary-building-report-current",
    article: "민원 처리기간",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "DURATION",
    sourceVersion: `정부24 현행 민원안내 확인 ${REVIEW_DATE}`,
    summary: "정부24는 가설건축물 축조신고의 공식 처리기간을 총 3일로 안내한다.",
  },
  {
    id: "cit-exp-forestland-temporary-use-report-official-duration",
    sourceId: "src-gov24-forestland-temporary-use-report-current",
    article: "민원 처리기간",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "DURATION",
    sourceVersion: `정부24 현행 민원안내 확인 ${REVIEW_DATE}`,
    summary: "정부24는 산지일시사용신고의 공식 처리기간을 총 10일, 신고기간 연장신고는 5일로 구분해 안내한다.",
  },
  {
    id: "cit-exp-standing-timber-felling-report-official-duration",
    sourceId: "src-gov24-standing-timber-felling-report-current",
    article: "민원 처리기간",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "DURATION",
    sourceVersion: `정부24 현행 민원안내 확인 ${REVIEW_DATE}`,
    summary: "정부24는 입목벌채·굴취 신고의 공식 처리기간을 총 30일로 안내한다.",
  },
  {
    id: "cit-exp-building-temporary-use-approval-decree",
    sourceId: "src-building-act-enforcement-decree-20260728",
    article: "제17조",
    paragraph: null,
    subparagraph: null,
    ...
    summary: "임시사용승인을 받을 수 있는 완성 부분의 구조·피난·방화 등 기준과 원칙적으로 2년 이내인 승인기간을 정한다.",
  },
  {
    id: "cit-exp-facility-management-document-registration-regulation",
    sourceId: "src-fms-operation-regulation-20240417",
    article: "제34조",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "APPLICABILITY",
    sourceVersion: "시행 2024-04-17",
    summary: "제1종·제2종시설물의 시설물관리대장과 설계도서는 준공·사용승인 전에, 감리보고서는 준공·사용승인 후 3개월 이내 FMS로 제출하도록 세부절차를 정한다.",
  },
  {
    id: "cit-exp-construction-restart-safety-inspection-guideline",
    sourceId: "src-construction-safety-management-guideline-current",
    article: "제21조제4항",
    paragraph: null,
    subparagraph: null,
    item: null,
    role: "APPLICABILITY",
    sourceVersion: "시행 2023-01-01",
    summary: "안전관리계획 대상 건설공사의 중단으로 시설물이 1년 이상 방치된 경우 공사를 재개하기 전에 공사재개 전 안전점검을 실시하도록 한다.",
  },
);
...
const additionalCitationIdsByProcedure: Record<string, string[]> = {
  ...
  "temporary-building-permit-report": [
    "cit-exp-temporary-building-report-official-duration",
  ],
  "forestland-temporary-use-permit-report": [
    "cit-exp-forestland-temporary-use-report-official-duration",
  ],
  "standing-timber-felling-permit-report": [
    "cit-exp-standing-timber-felling-report-official-duration",
  ],
  "building-temporary-use-approval": [
    "cit-exp-building-temporary-use-approval-decree",
  ],
  "facility-management-document-registration": [
    "cit-exp-facility-management-document-registration-regulation",
  ],
  "construction-restart-safety-inspection": [
    "cit-exp-construction-restart-safety-inspection-guideline",
  ],
};

const additionalDurationCitationIdsByProcedure: Record<string, string[]> = {
  "temporary-building-permit-report": [
    "cit-exp-temporary-building-report-official-duration",
  ],
  "forestland-temporary-use-permit-report": [
    ...
    citationIds: [...new Set([
      override
        ...
        : seed.durationSourceId
          ...
          : `cit-exp-${seed.id}`,
      ...(durationReferenceCitationIdsByProcedure[seed.id] ?? []),
      ...(additionalDurationCitationIdsByProcedure[seed.id] ?? []),
    ])],
    sampleSize: null,
    ...
    estimateConfidence: override
      ...
      : seed.days
        ...
        : referencePeriods?.some((period) => period.range !== null)
          ? "LOW"
          : "UNVERIFIED",
    planningBasis: override?.planningBasis ?? seed.durationPlanningBasis ?? (override?.endToEndKnown === false
      ? "INSUFFICIENT_DATA"
      : authorityProcessing
        ? "DIRECT_OFFICIAL"
...
export const expandedEdges: ProcedureEdge[] = [
  ...
  edge("edge-exp-private-road-to-road-connection", "private-road-opening-permit", "road-connection-permit", "rule-exp-private-road-opening-permit", "사도 노선·구조와 공공도로 접속지점을 확정한 뒤 별도의 도로 연결허가 필요 여부를 확인합니다.", "PRACTICAL"),
