...
- 절차 카탈로그: 입지·건축, 환경, 화학, 산업안전, 소방, 전기, 가스, 에너지까지 162개 인허가·신고·검사·사전검토 절차
- 지원 지역: 서울·인천·경기를 포함한 전국 16개 광역자치단체(2026년 행정구역 기준, 시·군·구 선택)
- 수도권 추가 검토: 500㎡ 이상 제조업 공장의 법정 권역·허용 예외·공장건축 총량, 30만㎡ 이상 공업용지 조성사업 심의, 한강수계·팔당 입지규제와 오염부하량, 도로점용공사 교통소통대책을 별도 절차로 표시하되 필지·법정 권역·최신 공고 확인 전에는 입지 가능·불가를 자동 확정하지 않음
- 전국·지역 입지 검토: 개발제한구역, 민간공항, 교육환경보호구역, 철도보호지구, 수도법상 공장설립 제한·승인지역, 폐수배출시설 설치제한지역과 시·도 조례 환경영향평가를 사용자 확인값과 공식 원문에 따라 구분
- 입주계약 분기: 산업단지·1종 항만배후단지·자유무역지역의 실제 계약 근거 법률을 하나만 선택하고, 자유무역지역의 공장설립승인 의제는 입주자격·계약완료·증빙이 모두 확인된 경우에만 반영
...
선택 지역의 ELIS 현행 자치법규는 관련 조례 상세 원문으로 연결합니다. 서울 25개 자치구, 2026년 개편 후 인천 11개 군·구, 경기 31개 시·군도 검토 저장본에 포함합니다. 다만 개별 산업단지 관리기본계획, 조례 별표·연도별 고시, 시설·물질·수량별 세부 임계값과 필지별 입지규제는 원문과 관할기관에서 다시 확인해야 합니다. 전체 목록은 [coverage-and-gaps.md](docs/coverage-and-gaps.md)에 있습니다.
...
- 카탈로그 버전: `2026.08.24-permits.18-capital-agency-detailed`
- 마지막 법령·정부24·ELIS 공개페이지 검토: `2026-08-24`
