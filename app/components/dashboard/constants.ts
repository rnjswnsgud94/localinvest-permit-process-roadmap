...
const inputLabels: Record<string, string> = {
  ...
  "entryContract.regime": "입주계약 적용 법률",
  entryContractRegime: "입주계약 적용 법률",
  "entryContract.eligibilityConfirmed": "입주자격 확인 결과",
  entryEligibilityConfirmed: "입주자격 확인 결과",
  "entryContract.status": "입주계약 진행상태",
  entryContractStatus: "입주계약 진행상태",
  "entryContract.zoneName": "입주 구역명",
  entryZoneName: "입주 구역명",
  "entryContract.managingAuthority": "관리권자·관리기관",
  entryManagingAuthority: "관리권자·관리기관",
  "entryContract.evidence": "입주계약 증빙",
  entryContractEvidence: "입주계약 증빙",
  ...
  "environment.localEnvironmentalAssessmentRequired": "시·도 조례 환경영향평가 대상 여부",
  localEnvironmentalAssessmentRequired: "시·도 조례 환경영향평가 대상 여부",
